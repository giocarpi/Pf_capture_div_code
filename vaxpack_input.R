vaxpack_input_params <- function (path, ref, genename, ploidycount) {
  ...
  #xie186#path <- readline (" My folder path <- ")
  path <- gsub("\"", "", path)
  ...
  #xie186#ref <- readline (" My ref .fasta file path <- ")
  ref <- gsub("\"", "", ref)
  ...
  cat (" \n")
  #xie186#genename <- readline (" What is the name of the gene you're analysing? <- ")
  cat (" \n")
